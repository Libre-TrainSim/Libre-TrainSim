...
func green() -> void:
	if signal_logic.warn_speed > 0 and signal_logic.warn_speed <= 60:
		...
		$formsignal_vo/Armature/Skeleton3D/lowerLight/Orange.visible = true
		$formsignal_vo/Armature/Skeleton3D/upperLight/Green.visible = true
		$formsignal_vo/Armature/Skeleton3D/upperLight/Orange.visible = false
		$formsignal_vo/Armature/Skeleton3D/lowerLight/Green.visible = false
	else:
		anim_fsm.travel("Vr1")  # Fahrt erwarten
		$formsignal_vo/Armature/Skeleton3D/lowerLight/Green.visible = true
		$formsignal_vo/Armature/Skeleton3D/upperLight/Green.visible = true
		$formsignal_vo/Armature/Skeleton3D/lowerLight/Orange.visible = false
		$formsignal_vo/Armature/Skeleton3D/upperLight/Orange.visible = false
...
func orange() -> void:
	...
	$formsignal_vo/Armature/Skeleton3D/lowerLight/Orange.visible = true
	$formsignal_vo/Armature/Skeleton3D/upperLight/Orange.visible = true
	$formsignal_vo/Armature/Skeleton3D/lowerLight/Green.visible = false
	$formsignal_vo/Armature/Skeleton3D/upperLight/Green.visible = false
